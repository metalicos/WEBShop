...
<form enctype="multipart/form-data" method="post" action="controller"
        ...
        <div class="d-md-flex d-sm-block align-content-center justify-content-between">
            <div class="col-md-5 py-2 py-sm-2 py-md-1">
                <input type="text" name="pNameUa" placeholder="Назва товару українською"
                       class="form-control input" required autofocus/>
            </div>
            <div class="col-md-5 py-2 py-sm-2 py-md-1">
    ...
    <div class="form-group">
        ...
        <textarea name="pAboutUa" cols="30" rows="3" class="text-area w-100 text-field" required autofocus
                  style="height: 100px;min-height: 40px;"></textarea>
    </div>
    <div class="form-group">
        <h1 class="h5">Product description</h1>
        <textarea name="pAboutEn" cols="30" rows="3" class="text-area w-100 text-field" required autofocus
                  style="height: 100px;min-height: 40px;"></textarea>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="d-md-flex d-sm-block align-content-center justify-content-between">
            <div class="col-md-5 py-2 py-sm-2 py-md-1">
                <input type="text" name="pColorUa" placeholder="Колір товару українською" required autofocus
                       class="form-control input"/>
            </div>
            <div class="col-md-5 py-2 py-sm-2 py-md-1">
                <input type="text" name="pColorEn" placeholder="Product color in English" required autofocus
                       class="form-control input"/>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="d-md-flex d-sm-block align-content-center justify-content-between">
            ...
            <div class="input-group">
                <div class="col-6">
                    <input type="number" placeholder="0.00" name="pSizeWidth" min="0" value="0" step="0.01" required autofocus
            ...
            <div class="input-group">
                <div class="col-6">
                    <input type="number" placeholder="0.00" name="pSizeHeight" min="0" value="0" step="0.01" required autofocus
                           class="form-control input" style="height: 40px"/>
                </div>
            ...
            <div class="input-group">
                <div class="col-6">
                    <input type="number" placeholder="0.00" name="pSizeDepth" min="0" value="0" step="0.01" required autofocus
                           class="form-control input" style="height: 40px"/>
                </div>
    ...
    <div class="form-group">
        ...
        <select name="categoryId" class="form-select-md w-100" required autofocus style="height: 40px;">
    ...
    <div class="form-group">
        ...
        <div class="d-md-flex d-sm-block align-content-center justify-content-between">
            <input type="number" name="productPrice" placeholder="0.0" min="0.0" value="0" step="0.1" required autofocus
                   class="form-control input"/>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="d-md-flex d-sm-block align-content-center justify-content-between">
            <input type="number" name="productAmount" placeholder="0" min="0" value="0" step="1" required autofocus
                   class="form-control input"/>
        </div>
    </div>
    ...
    <div class="py-2 justify-content-between">
        ...
        <input class="text-dark h5" type="file" name="photo1" required autofocus>

        <h1 class="h5">Додаткова фотографія</h1>
        <input class="text-dark h5" type="file" name="photo2" required autofocus>

        <h1 class="h5">Додаткова фотографія</h1>
        <input class="text-dark h5" type="file" name="photo3" required autofocus>
    </div>
